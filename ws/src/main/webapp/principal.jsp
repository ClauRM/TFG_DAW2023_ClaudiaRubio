...
<body class="h-100">
	...
	<nav id="menu" class="navbar navbar-expand-lg navbar-light">
		...
		<a href="Controlador?menu=home" target="iframe"><img src="img/cronomed.png" alt="" width="50" height="44"></a>
	...
	<div style="height: 85%;">
		<div class="h-100">
			<iframe src="home.jsp"name="iframe" style="height: 100%; width: 100%"></iframe>	
		</div>
	</div>
	<!-- PIE DE PAGINA -->
	    <div>
