...
public class ValidarAcceso extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (accion.equalsIgnoreCase("Login")) {
			...
			hayErrores = Utilidades.validaUsuarioRegistro(userTemporal); //verifico errores tras validar el usuario temporal

			//if(!email.equalsIgnoreCase("") && !pass.equalsIgnoreCase("")&& !usuario.equalsIgnoreCase("")) {
