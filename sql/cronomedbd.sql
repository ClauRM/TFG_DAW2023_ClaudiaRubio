...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2023 a las 18:26:01
...
(1, 'claudia', 'claudia@email.com', '96e79218965eb72c92a549dd5a330112', 1),
(2, 'mateo', 'mateo@email.com', '3ad284e1037316d0a8ea11b5f01a59e5', 0),
(3, 'usuario', 'usuario@email.com', 'e10adc3949ba59abbe56e057f20f883e', 0),
(13, 'victor', 'victor@email.com', '52c69e3a57331081823331c4e69d3f2e', 0);
...
--
ALTER TABLE `medicamentos`
  MODIFY `idmedicamento` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT de la tabla `tratamientos`
--
ALTER TABLE `tratamientos`
  MODIFY `idtratamiento` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `idusuario` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
